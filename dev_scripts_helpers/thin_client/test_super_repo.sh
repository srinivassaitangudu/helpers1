...
DIR_SUFFIX="sports_analytics"

# dev_scripts_{DIR_SUFFIX}/thin_client/build.py

# Test helpers setenv.
(cd helpers_root; source dev_scripts_helpers/thin_client/setenv.sh)

# Test super-repo setenv.
source dev_scripts_${DIR_SUFFIX}/thin_client/setenv.sh

# Test tmux.
dev_scripts_${DIR_SUFFIX}/thin_client/tmux.py --create_global_link
dev_scripts_${DIR_SUFFIX}/thin_client/tmux.py --index 1
